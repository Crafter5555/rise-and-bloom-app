...
CREATE TABLE public.digital_wellbeing_settings (
  ...
  daily_screen_time_goal_minutes INTEGER DEFAULT 480,
  focus_session_goal_minutes INTEGER DEFAULT 120,
...
CREATE INDEX idx_focus_sessions_user_start_time ON public.focus_sessions(user_id, start_time);
